...
public class DataEditor
{
    ...
    private static void ExcelToXml(string name)
    {
        ...
        SerializeUtils.Xmlserialize(XmlPath + xmlName, objClass);
    ...
    private static object GetObjFormXml(string name)
    {
        ...
        if (type != null)
        {
            ...
            return SerializeUtils.XmlDeserialize(xmlPath, type);
        }
    ...
    private static void XmlToBinary(string name)
    {
        ...
        try
        {
            ...
            if (type != null)
            {
                ...
                object obj = SerializeUtils.XmlDeserialize(xmlPath, type);
                SerializeUtils.BinarySerilize(binaryPath, obj);
    ...
    private static void ClassToXml(string name)
    {
        ...
        try
        {
            ...
            if (type != null)
            {
                ...
                string xmlPath = XmlPath + name + ".xml";
                SerializeUtils.Xmlserialize(xmlPath, temp);
